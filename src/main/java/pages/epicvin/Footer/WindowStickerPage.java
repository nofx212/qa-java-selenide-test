...
public class WindowStickerPage implements Meta {
    ...
    public static SelenideElement searchWidget = $x("//section[contains(@class,'form-widget')]//h2");
    ...
    public String windowStickerBlock(SelenideElement block) {
