...
public class FreeTitleCheckByVinPage implements SearchByVinPlate, Meta {
  ...
  public static SelenideElement block5 = $x("//section[@id='similar-blog']//h2");

  public String titleCheckBlock(SelenideElement block) {
